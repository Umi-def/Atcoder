...
//     rSort(p);
//     // rep(i, m) cout << p[i].first << " " << p[i].second << endl;
//     //cout << endl;
//     ll c = 0;
//     rep(i, m)
//     {
...
//             if (a[sum] <= p[i].first)
//             {
//                 ans += (sum - tmp) * p[i].first;
//                 mes(ans);
//                 //debug(sum, p[i].first, p[i].second, ans);
//                 re0;
//             }
//             else
//             {
//                 while (a[sum] > p[i].first)
//                     sum--, c++;
//                 //debug(sum, a[sum], p[i].second, c);
//                 ans += p[i].first * (sum - tmp - c);
//                 for (ll j = sum + 1; j < n; j++)
//                     ans += a[j];
//                 mes(ans);
//                 re0;
//             }
//         }
//         else if (a[sum] <= p[i].first)
//         {
