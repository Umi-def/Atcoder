...
signed main(void)
{
    ...
    if (ans == 0 && even >= 1 && p == 0)
        ans = 1;
    //debug(ans);
    //debug(pow(2.0, double(even)));
    ans *= POW((ll)2, even);
    mes(ans);
    //mes(70368744177664);
}
//49 0
//23 15 69 12 39 69 20 69 1 73 88 87 51 76 49 96 10 58 70 11 17 10 82 35 44 75 21 21 41 67 37 88 95 24 99 76 94 33 30 35 30 50 50 76 27 44 14 58 34
//70368744177664

//31 0
//74 34 72 62 2 26 38 86 38 84 60 52 78 12 46 54 82 24 8 86 64 94 20 14 30 24 42 42 4 78 78
//2147483648